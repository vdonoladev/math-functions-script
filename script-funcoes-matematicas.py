...
def palindromo():
    nome = input(
        "Digite um nome e o programa irá verificar se é um palindrimo: ").strip().upper()
    sp = nome.split()
    juntar = ''.join(sp)
    texto = juntar[::-1]
...
def jogo():
    ...
    print("POOOO !!!")
    print("-="*20)
    print("Computador jogou {} e você jogou {}".format(
        escolha[computador], escolha[jogador]))
    print("-="*20)
...
def multiplicacao():
    ...
    result = num*num2
    print("O resultado da multiplição de {} x {} é igual a {}".format(
        num, num2, result))
